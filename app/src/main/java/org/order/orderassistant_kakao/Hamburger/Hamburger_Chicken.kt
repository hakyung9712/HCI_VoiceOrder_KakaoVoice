...
import kotlinx.android.synthetic.main.hamburger_chicken.*
...
class Hamburger_Chicken : AppCompatActivity() {
    //TTS
    val TAG = "Kakao"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(permission_network != PackageManager.PERMISSION_GRANTED) {
           ...
           //ActivityCompat.requestPermissions(this, arrayOf(Manifest.permission.RECORD_AUDIO), NETWORK_STATE_CODE)
            ...
            var strText = "메뉴 종류로는 상하이버거와 맥치킨이 있습니다. 이 중에 선택해주세요"
            //var strText="안녕"
            ttsClient?.play(strText)


            chicken_sttStart.setOnClickListener {
            ...
            listener1 = object : SpeechRecognizeListener {
                ...
                override fun onResults(results: Bundle?) {
                    ...
                    if (txt1 in texts.toString()) {
                        ...
                        Toast.makeText(applicationContext, "상하이 버거", Toast.LENGTH_LONG)
                            .show()
                        val intent =
